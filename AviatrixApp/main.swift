...
func refuel(myPlane : Aviatrix) {
    ...
    var refuelAmount = myPlane.maxFuel - myPlane.fuelLevel
    
    print("Refueling...")
    print("⛽ Here in \(myPlane.location), jet fuel costs \(refuelData)")
    print("⛽ You refueled \(refuelAmount) gallons totaling $\(refuelData * refuelAmount)")
}
...
var plane = Aviatrix(author:"Karen")
